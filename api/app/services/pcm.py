...
PLUGIN_VERSION = "1.4.1"  # bump when the plugin source changes — PCM update detection
...
BUILDER_REV = 12  # bump when the package builder output changes for the same mirror

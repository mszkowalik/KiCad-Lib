...
PLUGIN_VERSION = "1.5.0"  # bump when the plugin source changes — PCM update detection
...
BUILDER_REV = 13  # bump when the package builder output changes for the same mirror
